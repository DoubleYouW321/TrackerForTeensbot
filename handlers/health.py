...
async def cmd_physics(callback: CallbackQuery):
    ...
    await callback.message.answer('В разделе Здоровье и Активность ты можешь получить полезный совет из базы знаний, а также записывать и редактировать свои физические показатели:\n\n• Количество выпитых стаканов воды 💧\n• Часы сна 😴\n• Количество пройденных шагов 👣\n\nСравнивай их с нормой и следи за прогрессом!', reply_markup=kb.health)
